...
use crate::command::constants::{APPEND_COMMAND_STR, CONFIG_COMMAND_STR, COPY_COMMAND_STR, DBSIZE_COMMAND_STR, DECRBY_COMMAND_STR, DEL_COMMAND_STR, EXISTS_COMMAND_STR, EXPIREAT_COMMAND_STR, EXPIRE_COMMAND_STR, FLUSHDB_COMMAND_STR, GETDEL_COMMAND_STR, GETSET_COMMAND_STR, GET_COMMAND_STR, INCRBY_COMMAND_STR, LINDEX_COMMAND_STR, LLEN_COMMAND_STR, LPOP_COMMAND_STR, LPUSHX_COMMAND_STR, LPUSH_COMMAND_STR, LRANGE_COMMAND_STR, LREM_COMMAND_STR, LSET_COMMAND_STR, MGET_COMMAND_STR, MONITOR_COMMAND_STR, MSET_COMMAND_STR, PERSIST_COMMAND_STR, PING_COMMAND_STR, PUBSUB_COMMAND_STR, RENAME_COMMAND_STR, RPOP_COMMAND_STR, RPUSHX_COMMAND_STR, RPUSH_COMMAND_STR, SADD_COMMAND_STR, SCARD_COMMAND_STR, SET_COMMAND_STR, SISMEMBER_COMMAND_STR, SMEMBERS_COMMAND_STR, SORT_COMMAND_STR, SREM_COMMAND_STR, STRLEN_COMMAND_STR, TOUCH_COMMAND_STR, TTL_COMMAND_STR, TYPE_COMMAND_STR, CLEAR_COMMAND_STR};
...
use crate::command::clear_cmd::ClearCommand;
...
impl CommandBuilder {
    pub fn new(id_job: u32, logger: Logger<String>) -> CommandBuilder {
        ...
        commands.insert(
            String::from(CLEAR_COMMAND_STR),
            Box::new(ClearCommand::new(id_job, logger)),
        );
        CommandBuilder {
            commands,
            id_job_exec: id_job,
