...
impl ParseError {
    pub fn numeric_value(msg: &str) -> Self {
        ParseError{message: String::from(msg), cause: String::from(NUMERIC_VALUE_MSG)}
    }

    pub fn empty_value(msg: &str) -> Self {
        ParseError{message: String::from(msg), cause: String::from(EMPTY_VALUE_MSG)}
    }
}
...
mod tests {
    ...
    fn test_parse_error_equality() {
        let error_aa = ParseError{message: String::from("Test message A"), cause: String::from("Cause A")};
        let error_bb = ParseError{message: String::from("Test message B"), cause: String::from("Cause B")};
        let error_ab = ParseError{message: String::from("Test message A"), cause: String::from("Cause B")};
        let error_ba = ParseError{message: String::from("Test message B"), cause: String::from("Cause A")};
